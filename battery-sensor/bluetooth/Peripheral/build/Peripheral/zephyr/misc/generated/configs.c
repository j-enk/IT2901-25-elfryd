...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARM_CORTEX_M0_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_ADC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_MPU_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_SW_PWM_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF51_FLASH_CONTROLLER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NORDIC_QSPI_NOR_FLASH_LAYOUT_PAGE_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LBS_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RECV_WORKQ_SYS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_SRAM_SIZE, 0x8000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF51DK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF51DK_NRF51822, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF51822_QFAC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_COMPANY_ID, 0x0059);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ULL_HIGH_PRIO, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ULL_LOW_PRIO, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LOW_LAT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LOW_LAT_ULL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LOW_LAT_ULL_DONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_TIFS_HW, 1);

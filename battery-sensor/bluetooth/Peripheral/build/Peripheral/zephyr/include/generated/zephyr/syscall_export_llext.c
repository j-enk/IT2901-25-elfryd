...
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_cas;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_ptr_cas;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_add;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_sub;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_set;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_ptr_set;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_or;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_xor;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_and;
extern __weak ALIAS_OF(no_handler) void * const z_impl_atomic_nand;
